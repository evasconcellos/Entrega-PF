...
function compraTotal() {
    ...
    alert ("De todas formas si querés podés agregar más productos al carrito haciendo click en los botones predefinidos");
...
function pagar() {   { 
    ...
    window.alert (`Al artículo: "${productos[articulos].nombre}", por un total de: $${sumaTotal()}, le vas a agregar lo siguiente: \n`  + carrito.join(" \n") + `\nAhora tu compra consta de: $${total} + $${sumaTotal()}`
);
